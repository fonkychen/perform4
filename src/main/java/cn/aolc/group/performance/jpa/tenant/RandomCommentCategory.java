...
@Entity
@Table(name="Random_Comment_Category")
public class RandomCommentCategory implements TenantEntity{

	/**
	 * 
	 */
	private static final long serialVersionUID = -243602362742244348L;
